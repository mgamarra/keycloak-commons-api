...
mkdir -p /opt/jboss/keycloak/modules/system/layers/base/com/microsoft/main
cd /opt/jboss/keycloak/modules/system/layers/base/com/microsoft/main
...
#curl -L http://central.maven.org/maven2/com/microsoft/sqlserver/mssql-jdbc/7.2.1.jre8/mssql-jdbc-7.2.1.jre8.jar mssql-jdbc.jar
